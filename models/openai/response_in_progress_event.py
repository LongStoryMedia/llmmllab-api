...
class ResponseInProgressEvent(BaseModel):
    ...
    response: Annotated[Response, Field(..., description="The response that is in progress. ")]
    """The response that is in progress. """
    sequence_number: Annotated[int, Field(..., description="The sequence number of this event.")]
    """The sequence number of this event."""
    type: Annotated[Literal["response.in_progress"], Field(..., description="The type of the event. Always `response.in_progress`. ")]
