...
"""
    ...
    first_id: Annotated[str, Field(..., description="The identifier of the first eval run in the data array.")]
    """The identifier of the first eval run in the data array."""
    has_more: Annotated[bool, Field(..., description="Indicates whether there are more evals available.")]
    """Indicates whether there are more evals available."""
    last_id: Annotated[str, Field(..., description="The identifier of the last eval run in the data array.")]
