...
"""
    reason: Annotated[Optional[Literal["max_output_tokens", "content_filter"]], Field(default=None, description="The reason why the response is incomplete.")] = None
...
class Response(BaseModel):
    ...
    temperature: Annotated[Union[float, Any], Field(...)]
    top_logprobs: Annotated[Optional[Union[int, Any]], Field(default=None)] = None
    top_p: Annotated[Union[float, Any], Field(...)]
    ...
    model: Annotated[ModelIdsResponses, Field(..., description="Model ID used to generate the response, like `gpt-4o` or `o3`. OpenAI offers a wide range of models with different capabilities, performance characteristics, and price points. Refer to the [model guide](https://platform.openai.com/docs/models) to browse and compare available models. ")]
    ...
    tool_choice: Annotated[ToolChoiceParam, Field(...)]
    tools: Annotated[ToolsArray, Field(...)]
    truncation: Annotated[Optional[Union[Literal["auto", "disabled"], Any]], Field(default=None)] = None
    completed_at: Annotated[Optional[Union[float, Any]], Field(default=None)] = None
    conversation: Annotated[Optional[Union[Conversation2, Any]], Field(default=None)] = None
    created_at: Annotated[float, Field(..., description="Unix timestamp (in seconds) of when this Response was created. ")]
    """Unix timestamp (in seconds) of when this Response was created. """
    error: Annotated[ResponseError, Field(...)]
    ...
    instructions: Annotated[Union[Union[str, List[InputItem]], Any], Field(...)]
    object: Annotated[Literal["response"], Field(..., description="The object type of this resource - always set to `response`. ")]
    """The object type of this resource - always set to `response`. """
    output: Annotated[List[OutputItem], Field(..., description="An array of content items generated by the model.  - The length and order of items in the `output` array is dependent   on the model's response. - Rather than accessing the first item in the `output` array and   assuming it's an `assistant` message with the content generated by   the model, you might consider using the `output_text` property where   supported in SDKs. ")]
    """An array of content items generated by the model.  - The length and order of items in the `output` array is dependent   on the model's response. - Rather than accessing the first item in the `output` array and   assuming it's an `assistant` message with the content generated by   the model, you might consider using the `output_text` property where   supported in SDKs. """
    output_text: Annotated[Optional[Union[str, Any]], Field(default=None)] = None
    parallel_tool_calls: Annotated[bool, Field(default=True, description="Whether to allow the model to run tool calls in parallel. ")]
    """Whether to allow the model to run tool calls in parallel. """
    status: Annotated[Optional[Literal["completed", "failed", "in_progress", "cancelled", "queued", "incomplete"]], Field(default=None, description="The status of the response generation. One of `completed`, `failed`, `in_progress`, `cancelled`, `queued`, or `incomplete`. ")] = None
    """The status of the response generation. One of `completed`, `failed`, `in_progress`, `cancelled`, `queued`, or `incomplete`. """
    usage: Annotated[Optional[ResponseUsage], Field(default=None)] = None
