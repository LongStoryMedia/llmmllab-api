...
class ResponseReasoningSummaryPartDoneEvent(BaseModel):
    ...
    part: Annotated[Part, Field(..., description="The completed summary part. ")]
    """The completed summary part. """
    ...
    type: Annotated[Literal["response.reasoning_summary_part.done"], Field(..., description="The type of the event. Always `response.reasoning_summary_part.done`. ")]
    """The type of the event. Always `response.reasoning_summary_part.done`. """

    model_config = ConfigDict(extra="ignore")

ResponseReasoningSummaryPartDoneEvent.model_rebuild()