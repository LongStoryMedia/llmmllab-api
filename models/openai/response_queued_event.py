...
"""
    response: Annotated[Response, Field(..., description="The full response object that is queued.")]
    """The full response object that is queued."""
    sequence_number: Annotated[int, Field(..., description="The sequence number for this event.")]
    """The sequence number for this event."""
    type: Annotated[Literal["response.queued"], Field(..., description="The type of the event. Always 'response.queued'.")]
