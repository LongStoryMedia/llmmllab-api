...
"""
    ...
    non_preferred_output: Annotated[Optional[List[Union[ChatCompletionRequestAssistantMessage]]], Field(default=None, description="The non-preferred completion message for the output.")] = None
    """The non-preferred completion message for the output."""
    preferred_output: Annotated[Optional[List[Union[ChatCompletionRequestAssistantMessage]]], Field(default=None, description="The preferred completion message for the output.")] = None
    """The preferred completion message for the output."""

    model_config = ConfigDict(extra="ignore")

FineTunePreferenceRequestInput.model_rebuild()