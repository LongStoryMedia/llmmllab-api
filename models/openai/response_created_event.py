...
"""
    response: Annotated[Response, Field(..., description="The response that was created. ")]
    """The response that was created. """
    sequence_number: Annotated[int, Field(..., description="The sequence number for this event.")]
    """The sequence number for this event."""
    type: Annotated[Literal["response.created"], Field(..., description="The type of the event. Always `response.created`. ")]
