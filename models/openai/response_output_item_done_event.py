...
class ResponseOutputItemDoneEvent(BaseModel):
    ...
    item: Annotated[OutputItem, Field(..., description="The output item that was marked done. ")]
    ...
    type: Annotated[Literal["response.output_item.done"], Field(..., description="The type of the event. Always `response.output_item.done`. ")]
